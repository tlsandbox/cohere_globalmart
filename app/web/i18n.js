...
const STRINGS = {
  en: {
    ...
    suggest: 'Suggest',
    buy: 'Buy',
    ai_explain_title: 'AI Explain',
    ai_explain_heading: 'Matches {query}',
    ai_explain_query_matched: 'Query matched: {reason}.',
    ai_explain_selection_default: 'Selection logic: hybrid ranking blends exact keyword hits with style similarity.',
    ai_explain_selection_with_reasons:
      'Selection logic: {reasons} plus hybrid ranking across keyword and style similarity.',
    ai_explain_score_label: 'Query match',
    suggest_fit_score_label: 'Outfit fit',
    query_latest_request: 'your latest request',
    why_suggested: 'Why suggested',
    query_match_gender: 'gender: {value}',
    query_match_item_type: 'item type: {value}',
    query_match_color: 'color: {value}',
    query_match_occasion: 'occasion: {value}',
    query_match_season: 'season: {value}',
    query_match_style_keywords: 'style keywords: {value}',
    reason_keyword_relevance: 'Keyword relevance',
    reason_semantic_similarity: 'Semantic similarity',
    reason_cohere_rerank: 'Cohere rerank',
    reason_gender_aligned: 'Gender aligned',
    reason_article_type_match: 'Article type match',
    reason_color_preference_match: 'Color preference match',
    reason_season_aligned: 'Season aligned',
    reason_usage_aligned: 'Usage aligned',
    reason_recency_boost: 'Recency boost',
    reason_overall_fit: 'overall style intent and category fit',
    quantity: 'Qty',
    remove: 'Remove',
  ...
  ja: {
    ...
    card_actions_hint: 'カード操作: 解説 / 提案 / 購入',
    complete_look_title: 'コーデを完成',
    complete_look_note: 'おすすめ商品でSuggestを押すと、相性の良い追加アイテムを提案します。',
    explain: '解説',
    suggest: '提案',
    buy: '購入',
    ai_explain_title: 'AI解説',
    ai_explain_heading: '{query} に一致',
    ai_explain_query_matched: '一致理由: {reason}。',
    ai_explain_selection_default: '選定ロジック: キーワード一致とスタイル類似度を組み合わせたハイブリッド検索です。',
    ai_explain_selection_with_reasons: '選定ロジック: {reasons} と、キーワード＋スタイル類似度のハイブリッド検索を使用。',
    ai_explain_score_label: 'クエリ一致度',
    suggest_fit_score_label: 'コーデ適合度',
    query_latest_request: '直近のリクエスト',
    why_suggested: '提案理由',
    query_match_gender: '性別: {value}',
    query_match_item_type: 'アイテム種別: {value}',
    query_match_color: '色: {value}',
    query_match_occasion: '利用シーン: {value}',
    query_match_season: '季節: {value}',
    query_match_style_keywords: 'スタイルキーワード: {value}',
    reason_keyword_relevance: 'キーワード一致',
    reason_semantic_similarity: '意味的類似',
    reason_cohere_rerank: 'Cohere再ランキング',
    reason_gender_aligned: '性別一致',
    reason_article_type_match: 'アイテム種別一致',
    reason_color_preference_match: '色の好み一致',
    reason_season_aligned: '季節一致',
    reason_usage_aligned: '利用シーン一致',
    reason_recency_boost: '新しさブースト',
    reason_overall_fit: '全体スタイル意図とカテゴリ適合',
    quantity: '数量',
    remove: '削除',
    ...
    status_use_actions: '各アイテムで 解説 / 提案 / 購入 を利用できます。',
    empty_cart: 'カートは空です。',
  },
  zh: {
    brand_eyebrow: '环球时尚',
    ...
    card_actions_hint: '卡片操作：解释 / 推荐 / 购买',
    complete_look_title: '完善穿搭',
    complete_look_note: '点击推荐商品上的 Suggest，生成搭配补充商品。',
    explain: '解释',
    suggest: '推荐',
    buy: '购买',
    ai_explain_title: 'AI 解释',
    ai_explain_heading: '匹配 {query}',
    ai_explain_query_matched: '匹配依据：{reason}。',
    ai_explain_selection_default: '选择逻辑：混合检索同时结合关键词匹配与风格语义相似度。',
    ai_explain_selection_with_reasons: '选择逻辑：{reasons}，并结合关键词+风格语义的混合检索。',
    ai_explain_score_label: '查询匹配度',
    suggest_fit_score_label: '搭配匹配度',
    query_latest_request: '你最近的请求',
    why_suggested: '推荐理由',
    query_match_gender: '性别：{value}',
    query_match_item_type: '品类：{value}',
    query_match_color: '颜色：{value}',
    query_match_occasion: '场景：{value}',
    query_match_season: '季节：{value}',
    query_match_style_keywords: '风格关键词：{value}',
    reason_keyword_relevance: '关键词相关',
    reason_semantic_similarity: '语义相似',
    reason_cohere_rerank: 'Cohere 重排',
    reason_gender_aligned: '性别一致',
    reason_article_type_match: '品类匹配',
    reason_color_preference_match: '颜色偏好匹配',
    reason_season_aligned: '季节匹配',
    reason_usage_aligned: '场景匹配',
    reason_recency_boost: '新品加权',
    reason_overall_fit: '整体风格意图与品类匹配',
    quantity: '数量',
    remove: '移除',
    ...
    status_use_actions: '每个商品支持 解释 / 推荐 / 购买。',
    empty_cart: '购物车为空。',
  },
  es: {
    brand_eyebrow: 'GlobalMart Fashion',
    ...
    card_actions_hint: 'Acciones: Explicar, Sugerir, Comprar.',
    ...
    suggest: 'Sugerir',
    buy: 'Comprar',
    ai_explain_title: 'Explicación IA',
    ai_explain_heading: 'Coincide con {query}',
    ai_explain_query_matched: 'Coincidencia de consulta: {reason}.',
    ai_explain_selection_default: 'Lógica de selección: ranking híbrido con coincidencias de palabras clave y similitud de estilo.',
    ai_explain_selection_with_reasons:
      'Lógica de selección: {reasons} más ranking híbrido por palabras clave y similitud de estilo.',
    ai_explain_score_label: 'Coincidencia de consulta',
    suggest_fit_score_label: 'Ajuste del look',
    query_latest_request: 'tu solicitud más reciente',
    why_suggested: 'Por qué se sugiere',
    query_match_gender: 'género: {value}',
    query_match_item_type: 'tipo: {value}',
    query_match_color: 'color: {value}',
    query_match_occasion: 'ocasión: {value}',
    query_match_season: 'temporada: {value}',
    query_match_style_keywords: 'palabras clave: {value}',
    reason_keyword_relevance: 'Relevancia por palabra clave',
    reason_semantic_similarity: 'Similitud semántica',
    reason_cohere_rerank: 'Rerank de Cohere',
    reason_gender_aligned: 'Género alineado',
    reason_article_type_match: 'Coincidencia de tipo de artículo',
    reason_color_preference_match: 'Coincidencia de color',
    reason_season_aligned: 'Temporada alineada',
    reason_usage_aligned: 'Uso alineado',
    reason_recency_boost: 'Impulso por recencia',
    reason_overall_fit: 'intención de estilo general y ajuste de categoría',
    quantity: 'Cant.',
    remove: 'Quitar',
    ...
    status_use_actions: 'Usa Explicar, Sugerir o Comprar en cada artículo.',
